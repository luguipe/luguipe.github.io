document.addEventListener('DOMContentLoaded', function() {
    ...
    <div id="introContainer" style="padding: 10px; border: 1px solid #ccc; margin: 10px;">
        ...
        <div style="flex-grow: 1; margin-left: 10px;">
            <p><img src="images/GuiWindow.jpg" alt="Luiz Perez" style="max-width: 100%; height: auto; flex-shrink: 0; width: 150px; margin-bottom: 20px;">👋 How's it going, folks! 🚀 I'm Luiz Perez, currently navigating the wild seas of coding as a student at MIT xPro's Full Stack Development course in MERN.</p>
        ...
        <div>
            <iframe width="420" height="345" src="https://www.youtube.com/embed/YNWENML4PAA?controls=1" title="Video Introduction"></iframe>
        </div>
</div>
